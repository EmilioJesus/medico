...
class principaldoctor extends Component {
                                            ...
                                            .then((docRef) => {
                                                ...
                                                db.collection("Usuarios").doc(uid).collection('Citas').doc(id).delete().then(() => {
                                                    ...
                                                    if (tipocita == "Presencial") {
                                                        db.collection("Usuarios/"+uid+"/HorariosPresencial").doc(dia).collection(dia+"1").doc(indice).update({
                                                        hora:horario
                                                        });
                                                    } else {
                                                        db.collection("Usuarios/"+uid+"/HorariosLinea").doc(dia).collection(dia+"1").doc(indice).update({
                                                        hora:horario
                                                        });
                                                    }
                                                }).catch((error) => {
    ...
    render() {
        ...
        return (
            ...
            <div className="" onload={this.logeado, this.especialidad, this.estado}>
                <a href="/perfil_doctor">Perfil</a><br />
